<header class="z-10 py-4 bg-white dark:bg-gray-800 border-b dark:border-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-success dark:text-purple-300">
        <!-- Mobile hamburger -->
